...
servername = '184.105.4.175:1433' #sql server name/ip address
database = 'zz' #sql server database power_outage_data
username = 'zzaiken'  #sql server username
password = 'power_outage_smu123' #sql server password
